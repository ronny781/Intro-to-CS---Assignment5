...
public class BankAccount {
   ...
   public boolean depositMoney(int amount) {
    	// task 1a
        if(amount<0) //If the amount is  negative the return false
        	return false;
        else //Else add it to balance
    ...
    public boolean withdrawMoney(int amount) {
    	// task 1b
    	 if(amount<0 | amount > balance)
         	return false; //If the amount is  negative or it's bigger then balance return false
